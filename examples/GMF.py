...
from autorecsys.pipeline import Input, LatentFactorMapper, PointWiseOptimizer, ElementwiseInteraction
...
def gmf_pipeline():
    ...
    innerproduct_output = ElementwiseInteraction(elementwise_type = "innerporduct")([user_emb, item_emb])
