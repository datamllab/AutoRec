...
class Search(object):
    ...
    def search(self, x=None, y=None, x_val=None, y_val=None, objective=None, batch_size=None, **fit_kwargs):
        ...
        tuner.search(x=x, y=y, x_val=x_val, y_val=y_val, batch_size=batch_size, **fit_kwargs)
