...
class BasePreprocessor(metaclass=ABCMeta):
    ...
    def format_dataset(self):
        ...
        Note:
            User is responsible for implementing unsupported data formatters.
        """
        raise NotImplementedError

    def load_dataset(self):
        """ Load CSV data into Pandas DataFrame format.
        """
    ...
    def transform_categorical(self):
        ...
        Note:
            Produce fit dictionary for categorical data.
            Transform categorical data using fit dictionary.
        """
    ...
    def get_hash_size(self):
        ...
        Returns:
            (list): Integer number of distinctive categories associated with every categorical data columns.
        """
    ...
    def get_x(self):
        ...
        Returns:
            (DataFrame): The training data columns.
        """
        return self.data_df.drop(columns=self.target_column, inplace=False)

    def get_x_numerical(self, x):
        """ Get the numerical part of the training data columns.

        Args:
            x (DataFrame): The training data columns.

        Returns:
            (ndarray): The numerical part of the training data columns.
        """
        return x[self.numerical_columns].values

    def get_x_categorical(self, x):
        """ Get the categorical part of the training data columns.

        Args:
            x (DataFrame): The training data columns.

        Returns:
            (ndarray): The categorical part of the training data columns.
        """
        return x[self.categorical_columns].values

    def get_y(self):
        """ Get the training label column.

        Returns:
            (ndarray): The training label column.
        """
    ...
    def get_numerical_count(self):
        ...
        Returns:
            (int): The number of numerical columns.
        """
    ...
    def split_data(self, x, y, test_percentage):
        ...
        Returns:
            x_train (ndarray): Matrix associated with the part of numerical and categorical data for model training.
            x_test (ndarray): Matrix associated with the part of numerical and categorical data for model testing.
            y_train (ndarray): Matrix associated with the part of label data used to train model.
            y_test (ndarray): Matrix associated with the part of label data for model testing.
        """
...
class AvazuPreprocessor(BasePreprocessor):
    ...
    def preprocess(self):
        ...
        Returns:
            x_train (ndarray): Training set of the numerical and categorical data.
            y_train (ndarray): Training set of the label data.
            x_validate (ndarray): Validation set of the numerical and categorical data.
            y_validate (ndarray): Validation set of the label data.
            x_test (ndarray): Testing set of the numerical and categorical data.
            y_test (ndarray): Testing set of the label data.
        """
...
class MovielensCTRPredictionPreprocessor(BasePreprocessor):
    """ Preprocess the Movielens 1M dataset for CTR prediction.
    ...
    def __init__(self,
                 non_csv_path=None,
                 csv_path='/home/thwang1231/autorec/examples/datasets/ml-1m/ratings.dat',
                 header=None,  # inferred in load_data()
                 columns=None,
                 delimiter='::',
                 filler=0.0,
    ...
    def preprocess(self):
        ...
        # Step 5: Conduct negative sampling.
        x_train, x_test, y_train, y_test = self.split_data(x, y, self.test_percentage)
        x_train, x_validate, y_train, y_validate = self.split_data(x_train, y_train, self.validate_percentage)
